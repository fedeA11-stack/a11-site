...
export const ALL_PROJECTS: CSProject[] = [
  ...
  { name: "TokenStudio", href: "/tokenstudio", preview: "/assets/All%20Projects/Tokenization.png",      nextImage: `${NP}/freehold%20tokenisation%20-case.png`, logo: `${NP}/freehold.svg`       },
